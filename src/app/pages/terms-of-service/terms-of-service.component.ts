...
@Component({
    ...
    <div class="min-h-screen bg-base-100 py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-4xl mx-auto bg-base-200 rounded-lg shadow-xl p-8 prose prose-invert">
        <h1>Terms of Service</h1>
        <p class="text-sm text-gray-400">Last updated: November 30, 2024</p>

        <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the JeuFutbol website (the "Service") operated by JeuFutbol ("us", "we", or "our").</p>
        ...
        <ul>
            <li>By email: jeufutbol@gmail.com</li>
        </ul>
      </div>
    </div>
  `
